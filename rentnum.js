...
const cont_head = document.querySelectorAll(".cont-head")
const content_after = document.querySelectorAll(".content-after")

cont_head.forEach((cont,index) => {
    cont.addEventListener("click", ()=>{
        content_after[index].style.display = "block"
        cont.classList.toggle(".activate")
    })
})

popup_btn.addEventListener("mouseenter", () =>{
    popup.classList.add("popup-opened")
})
popup_btn.addEventListener("mouseleave", () =>{
